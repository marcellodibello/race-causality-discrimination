...
Since we have introduced the topic of racial discrimination – as opposed to simply studying the causal role race –  it is worth spending time on what discrimination is and how it is measured, along with potential pitfalls of standard ways to study discrimination. 
...
To what extent can a manipulationist account model the causal role of race in a structural sense? Some think the framework can capture this structural picture. But how do such accounts model the causal role of race? This remains largely an open question. 
