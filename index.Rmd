...
Tue	10:30-1:20 PM in Tempe, [COOR](https://www.asu.edu/map/interactive/?psCode=COOR) 3301
...
questions about race, causality and discrimination. You will sharpen your critical thinking 
...
Your essay should begin with a careful theoretical summary of the key ideas in the manipulationist account (1-2 pages). After that, you should apply the account to a specific case study in the social sciences and show how the account can be useful in modeling causation (1-2 pages). Finally, you should raise problems and difficulties for the account, using the case study or other examples (1-2- pages). Please draw from the course readings as needed and demonstrate a careful and deep engagement with them. 

**2**. After doing independent research, collect and summarize a **case study** that illustrates why it is difficult
to investigate the causal role of race. The first part of your essay (1-2 pages) should describe your case study. Topics for your case study could include, but are not limited to, health care, criminal justice, education, hiring and employment.  The second part (3-4 pages) should draw from the readings on the philosophy of race. 

**3**. Write a **philosophical argumentative essay** that examines the topic "Philosophical Challenges to the Study of Racial Discrimination". In examining this topic, you should draw from the course readings on racial discrimination. You may (but need not to) build on the case study you discussed in your second essay.  Your essay can be primarily negative, say you argue that the challenges are insurmountable. Your essay can also be more positive, say you describe the challenges and propose ways to address them. 
...
Racial disparities are widely studied and well-known. More difficult is to study 
...
Fryer](https://scholar.harvard.edu/fryer/home) argued that available data show no racial bias again black men in police killings. In fact, Fryer's study showed that 
black civilians are *less* likely to be killed by the police compared to similarly situated whites.
Many rejected this conclusion despite the study's meticulously reliance on data and rigorous statistical modeling.
...
And yet, even if race is not 
a variable that can be manipulated, it still plays a causal role, just like 
class or gender can very well have a causal role. So, perhaps, the slogan 
"no causation without manipulation"  is overly restrictive. 
...
- Marcellesi (2013), [Is Race a Cause?](https://www.marcellodibello.com/race-causality-discrimination/readings/)
...
**Week 5: Signals of Race**

How do social scientists respond to these challenges? We will look at a few examples of studies in sociology and economics that make causal claims about race. In these studies, race (or to be more precise, a variable that is a signal for race) is still manipulated. Is the manipulationist account, then, secure from objections when it comes to social categories such as race?
...
**Week 10: Manipulation and Racial Discrimination**
...
Now, if race is socially constructed, how can it be subject to statistical analysis by manipulating it as a variable or controlling for other variables?


*Essential readings*

- Kohler-Hausmann (2018), [Eddie Murphy and the Dangers of Counterfactual Causal Thinking about Detecting Racial Discrimination](https://scholarlycommons.law.northwestern.edu/cgi/viewcontent.cgi?article=1374&context=nulr)

- Naftali Weinberger (2022), [Signal Manipulation and the Causal Analysis of Racial Discrimination](https://www.marcellodibello.com/race-causality-discrimination/readings/Signal-Manipulation-Causal-Race-2023.pdf)
...
**Week 11: Race in Racial Discrimination**


Since we have introduced the topic of racial discrimination – as opposed to simply studying the causal role race –  it is worth spending time on what discrimination is and how it is measured, and whether standard ways to study discrimination are adequate in capturing the phenomenon. 
...
**Week 12: Race and Structure**

Instead of thinking of race as a single variable, race can be thought 
as embedded in a complex social structure. This week we examine an idea that is often mentioned, even in the mainstream media, namely "structural injustice". 


*Essential readings*

- Haslanger (2012), [Oppression: Racial and Other](), chapter 11 of the book *Resisting Reality*, Oxford University Press
...
To what extent can a manipulationist account model the causal role of race in a structural sense? Some think the framework can capture this structural picture. Hoes do such accounts apply to the causal role of race?


*Essential readings*


- Ross (2023), [What Is Social Structural Explanation? A Causal Account](Ross-SsocialStructExplNous-2023 .pdf)


- Malinsky (2018), [Intervening on structure](Malinski-InterveningStructure-2018.pdf)
