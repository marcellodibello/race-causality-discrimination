...
Claims of racial discrimination and structural racism are ubiquitous today. On one hand, studies in the social sciences show that, after controlling for variables other than race, racial disparities still persist in incarceration, health outcomes and wealth. Thus, race appears to be a key variable for explaining racial disparities. On the other, many point out that, again after controlling for variables other than race, the same racial disparities significantly decrease if not subside entirely. Thus, they think the explanatory role of race has been exaggerated. This debate leaves out a crucial question, however. What causal and explanatory role (if any) can race play in the first place? If, as many hold, race is a social construct emerging from the larger fabric of social interactions, does it make sense to isolate it and control for other variables? 

The course aims to untangle the assumptions about the causality of race that inform the ongoing debate about racial discrimination and structural racism. Readings will be drawn from three strands of research: the literature in the social sciences on racial inequalities; philosophical theories of race; the philosophical literature on causality.
...
How should we understand the nature of causality and how should we study causality? A prominent account in both statistics and philosophy is the so-called *manipulationist account*. This week and the next will be devoted to understanding this manipulationist account. 
...
The manipulationist account of causation faces several challenges when it comes to investigating the causal role of social categories, in particular, race. If, as the slogan goes, "no causation without manipulation", then race cannot be a cause insofar as race cannot be manipulated. But isn't this view too radical? Perhaps, race is not 
a variable that can be manipulated, but it still plays a causal role, just like 
class or gender can very well have a causal role.  
...
We should switch gears and look at philosophical accounts of race. Admittedly, we cannot talk about whether race is a cause without asking, what is race? So we need to ask this question now. 
We'll start with social constructionist views of race. 
...
real and race as a social illusion. 
...
Having clarified what we could mean by race, let's return to our original question.  How can we study the causal effects of race. We focus in particular on racial discrimination, one crucial way in which race can have a causal effect. 
If race is socially constructed, then how can it be subject to statistical analysis by manipulating race as a variable or controlling for other variables?
